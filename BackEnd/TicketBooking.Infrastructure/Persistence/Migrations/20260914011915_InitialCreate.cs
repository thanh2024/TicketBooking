        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Event_Time", "StartTime < EndTime");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TicketType_Quantity", "TotalQuantity > 0 AND SoldQuantity >= 0 AND SoldQuantity <= TotalQuantity");
                    table.CheckConstraint("CK_TicketType_SaleTime", "SaleStartTime < SaleEndTime");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HolderName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    HolderEmail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
